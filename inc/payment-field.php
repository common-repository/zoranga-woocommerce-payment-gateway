...
$denominations = [100, 200, 400, 500, 1000, 1500];
$denominationPrice = 0;
	...
	<div id="airtime-pin-form" class="payment-form">
    	...
    	<p class="form-row form-row-wide">
    		...
    		<select name="pin_network" id="pin_network" required="required" class="form-field">
    			<option value="2" selected="selected">MTN</option>
    			<option value="5">9 Mobile</option>
    ...
    <div id="airtime-transfer-form" class="payment-form">
    	...
    	<p class="form-row form-row-wide">
    		...
    		<select name="transfer_network" id="transfer_network" required="required" class="form-field"  >
    			<option value="4" selected="selected">MTN SHARE AND SELL</option>
    		</select>
    	</p>
    </div>
	<div>
		<input type="hidden" id="zoranga_object" name="zoranga_object" />
	</div>
</div>
<style>
    #custom_input{
...
function paymentMethodSelected(obj) {
	...
	document.querySelector('#custom_input #zoranga_object').value = z_object;
